...
\begin{align*}
  ...
  \tau_1 &= R_{\text{sig}} \cdot C_{gs1} \\
  \tau_2 &= \frac{v_x}{i_x} \cdot C_{gd1} \\
  &= \left( g_{m1} R_{d1} R_{\text{sig}} + R_{\text{sig}} + R_{d1} \right) \cdot C_{gd1} \\
  R_{d1} &= r_{o1} \| \frac{r_{o2} + R_L}{1 + g_{m2} r_{o2}} \\
  \tau_3 &= R_{d1} \cdot (C_{db1} + C_{gs2}) \\
  R_o &\approx g_{m2} r_{o2} r_{o1} \\
  \tau_4 &= (R_o \| R_L) \cdot (C_L + C_{gd2} + C_{db2})
\end{align*}
