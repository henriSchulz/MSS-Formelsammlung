...
$$
$$
V_GS1 = R \cdot I_1 = V_{TH} + \sqrt{\frac{I_1}{\frac{1}{2} \mu_n C_{ox} \left(\frac{W}{L}\right)_1}} \quad\text{für}\quad V_{G1} > V_{TH}
$$
$$
...
\includegraphics[width=\linewidth]{assets/ANA3.png}
...
\section{Spezifikation Lösungen aus der Übung}
...
\includegraphics[width=0.5\linewidth]{assets/ALU.png}
\includegraphics[width=0.5\linewidth]{assets/MUL.png}
\end{document}
